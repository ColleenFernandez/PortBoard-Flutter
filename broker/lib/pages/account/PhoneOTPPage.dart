        ...
        body: Column(
          ...
          children: [
            Container(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 10),
                  Text(phone, style: TextStyle(color: AppColors.lightBlue, fontWeight: FontWeight.bold))
                ],
              ),
            ),
            ...
            Container(
              ...
              }, child: Text('Wrong Number?', style: TextStyle(color: AppColors.lightBlue, fontSize: 16))),
            ),
            Container(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  }, child: Text('Resend', style: TextStyle(color: AppColors.lightBlue, fontSize: 18))),
                  Icon(Icons.arrow_right, color: AppColors.lightBlue)
                ],
              ),
            ),
            Visibility(
