                ...
                children: [
                  Container(
                    ...
                    child: TextField(
                      enabled: false,
                      decoration: InputDecoration(
                        focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: AppColors.lightBlue, width: 2)),
                  ...
                  Positioned(
                      ...
                      child: IconButton(onPressed: () {
                        showCalendar();
                      }, icon: Icon(Icons.calendar_today_rounded, color: AppColors.lightBlue)))
                ],
              ),
              Container(
                margin: EdgeInsets.only(left: 30, top: 20),
                  ...
                  children: [
                    ...
                    Positioned(right: 0, bottom: 0,
                        child: FloatingActionButton(
                            ...
                            }, child: Icon(Icons.camera_alt, color: AppColors.lightBlue)))
                  ],
                ),
              ),
              Container(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 40),
          Text('Thank you for your submit', style: TextStyle(fontSize: 20, color: AppColors.lightBlue)),
          SizedBox(height: 20),
