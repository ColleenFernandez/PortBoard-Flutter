...
class SelectVesselPage extends StatefulWidget{
  @override
  State<SelectVesselPage> createState() => _SelectVesselPageState();
}

class _SelectVesselPageState extends State<SelectVesselPage> {

  TextEditingController edtSearch = new TextEditingController();

  List<VesselModel> searchList = [];
  ...
  void initState() {
    ...
    searchList.addAll(Utils.sortData(Common.vesselList, sortKey) as List<VesselModel>);
  }
          ...
          children: [
            Container(
                  ...
                  child: TextField(
                    ...
                    onChanged: (text) {
                      searchList.clear();
                      Common.vesselList.forEach((element) {
