...
class SelectSteamShipLinePage extends StatefulWidget{
  @override
  State<SelectSteamShipLinePage> createState() => _SelectSteamShipLinePageState();
}

class _SelectSteamShipLinePageState extends State<SelectSteamShipLinePage> {

  TextEditingController edtSearch = new TextEditingController();

  List<SteamShipLineModel> searchList = [];
  ...
  void initState() {
    ...
    searchList.addAll(Utils.sortData(Common.steamshipLine, sortKey) as List<SteamShipLineModel>);
  }
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Select steamship line'),
          actions: [
          ...
          children: [
            Container(
                  ...
                  child: TextField(
                    ...
                    onChanged: (text) {
                      searchList.clear();
                      Common.steamshipLine.forEach((element) {
            ...
            Row(
              children: [
                ...
                SizedBox(width: 10),
                Text('Steamship lines', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              ],
            ),
            Container(
