...
class SelectGoodsPage extends StatefulWidget{
  @override
  State<SelectGoodsPage> createState() => _SelectGoodsPageState();
}
...
class _SelectGoodsPageState extends State<SelectGoodsPage> {
  ...
  List<GoodsTypeModel> searchList = [];
  ...
  void initState() {
    ...
    searchList.addAll(Utils.sortData(Common.goodsList, sortKey) as List<GoodsTypeModel>);
  }
          ...
          children: [
            Container(
                  ...
                  child: TextField(
                    ...
                    onChanged: (text) {
                      searchList.clear();
                      Common.goodsList.forEach((element) {
