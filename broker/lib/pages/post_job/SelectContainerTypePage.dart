...
class SelectContainerTypePage extends StatefulWidget{
  @override
  State<SelectContainerTypePage> createState() => _SelectContainerTypePageState();
}

class _SelectContainerTypePageState extends State<SelectContainerTypePage> {
  ...
  void initState() {
    ...
    searchList.addAll(Utils.sortData(Constants.containerType, sortKey) as List<String>);
  }
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Select container type'),
          actions: [
          ...
          children: [
            Container(
                  ...
                  child: TextField(
                    ...
                    onChanged: (text) {
                      searchList.clear();
                      Constants.containerType.forEach((element) {
            ...
            Row(
              children: [
                ...
                SizedBox(width: 10),
                Text('Container Types', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              ],
            ),
            Container(
