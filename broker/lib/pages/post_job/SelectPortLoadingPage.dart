...
class SelectPortLoadingPage extends StatefulWidget{
  @override
  State<SelectPortLoadingPage> createState() => _SelectPortLoadingPageState();
}

class _SelectPortLoadingPageState extends State<SelectPortLoadingPage> {

  TextEditingController edtSearch = new TextEditingController();

  List<PortLoadingModel> searchList = [];
  ...
  void initState() {
    ...
    searchList.addAll(Utils.sortData(Common.portLoadings, sortKey) as List<PortLoadingModel>);
  }
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Select port loading'),
          actions: [
          ...
          children: [
            Container(
                  ...
                  child: TextField(
                    ...
                    onChanged: (text) {
                      searchList.clear();
                      Common.portLoadings.forEach((element) {
            ...
            Row(
              children: [
                ...
                SizedBox(width: 10),
                Text('Port of Loading', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              ],
            ),
            Container(
