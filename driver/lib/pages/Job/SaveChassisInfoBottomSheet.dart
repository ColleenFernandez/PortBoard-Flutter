...
class SaveChassisInfoBottomSheet extends StatefulWidget {

  @override
  State<SaveChassisInfoBottomSheet> createState() => _SaveChassisInfoBottomSheetState();
}

class _SaveChassisInfoBottomSheetState extends State<SaveChassisInfoBottomSheet> {
                          ...
                          children: [
                            ...
                            Positioned(right: 10, bottom: 10,
                                child: InkWell(
                                  ...
                                  child: Image(image: isShowDetail ? Assets.IC_DOUBLE_ARROW_DOWN : Assets.IC_DOUBLE_ARROW_UP, width: 20,),
                                ))
                          ]
                      ),
                      Container(
